...
import { View, Text, FlatList, Pressable, Keyboard, KeyboardAvoidingView, StyleSheet, Platform, TouchableWithoutFeedback } from 'react-native';
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
            <View testID='goals-screen' style={styles.container}>
                ...
                <Text style={styles.subHeader}>
                    Choose up to 7 things important to you and how many hours per week you would like to spend on them
                </Text>
...
const styles = StyleSheet.create({
    ...
    tableHeader: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8, borderBottomWidth: 1 },
    columnHeader: { fontWeight: 'bold', flex: 1, textAlign: 'center' },
    addButton: { padding: 12, backgroundColor: '#007AFF', alignItems: 'center', marginVertical: 10, borderRadius: 5 },
